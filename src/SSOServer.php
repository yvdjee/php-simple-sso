...
namespace Kerwin\SimpleSSO;

use Kerwin\SimpleSSO\Exceptions\SSOServerException;
use Kerwin\SimpleSSO\Interfaces\SSOServerInterface;

/**
 * Class SSOServer. This class is only a skeleton.
 * First of all, you need to implement abstract functions.
 *
 * @package Kerwin\SimpleSSO
 */
